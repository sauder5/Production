codeunit 50098 "Data Cleaning -OnlyTransaction"
{
    // //Used for CRP2
    ...
    begin
        ...
        */
        ...
        /*//Clean Ez-Shipment History
        CleanTable(DATABASE::Table14110459);
        CleanTable(DATABASE::Table14110460);
        CleanTable(DATABASE::Table14110461);
        CleanTable(DATABASE::Table14110462);
        */
        //}
        ...
        // ezShipment //
        //************//
        //        CleanTable(DATABASE::Table14110455);
        //        CleanTable(DATABASE::Table14110456);
        //        CleanTable(DATABASE::Table14110457);
        //        CleanTable(DATABASE::Table14110458);
        //        CleanTable(DATABASE::Table14110459);
        //        CleanTable(DATABASE::Table14110460);
        //        CleanTable(DATABASE::Table14110461);
        //        CleanTable(DATABASE::Table14110462);
        //        CleanTable(DATABASE::Table14110482);
        //        CleanTable(DATABASE::Table14110481);
        //        CleanTable(DATABASE::Table14110483);
        //        CleanTable(DATABASE::Table14110490);
        //        CleanTable(DATABASE::Table14110491);
        //        CleanTable(DATABASE::Table14110492);
        //        CleanTable(DATABASE::Table14110493);
        //        CleanTable(DATABASE::Table14110494);
        //        CleanTable(DATABASE::Table14110495);
        //        CleanTable(DATABASE::Table14110496);
        //        CleanTable(DATABASE::Table14110497);
        //        CleanTable(DATABASE::Table14110498);
        //        CleanTable(DATABASE::Table14110499);
        //        CleanTable(DATABASE::Table14110500);
        //CleanTable(DATABASE::Table14110501);
        //        CleanTable(DATABASE::Table14110502);
        //        CleanTable(DATABASE::Table14110477);
        //        CleanTable(DATABASE::Table14110479);
        ...
        //ASSEMBLY transactional tables
        CleanTable(DATABASE::"Assembly Header");
        CleanTable(DATABASE::"Assembly Line");
        CleanTable(DATABASE::"Assemble-to-Order Link");
        CleanTable(DATABASE::"Assembly Comment Line");
        CleanTable(DATABASE::"Posted Assembly Header");
        CleanTable(DATABASE::"Posted Assembly Line");
        CleanTable(DATABASE::"Posted Assemble-to-Order Link");
