page 50097 "Production Lot Dashboard"
{
    // version GroProd
    ...
    layout
    {
        area(content)
        {
            ...
            group("Scale Tickets")
            {
                part(Control1000000027; "Scale Ticket List")
                {
                    SubPageLink = "Production Lot No." = FIELD("Production Lot No.");
                }
            }
            group("Grower Tickets")
            {
                //The GridLayout property is only supported on controls of type Grid
                //GridLayout = Columns;
                part(Control1000000029; "Grower Tickets")
                {
                    Provider = Control1000000027;
                    SubPageLink = "Production Lot No." = FIELD("Production Lot No."),
                                  "Scale Ticket No." = FIELD("Scale Ticket No.");
                }
                part(Control1000000030; "Applied Amounts")
                {
                    Provider = Control1000000029;
                    SubPageLink = "Production Lot No." = FIELD("Production Lot No."),
                                  "Grower Ticket No." = FIELD("Grower Ticket No.");
                }
            }
        }
    }
