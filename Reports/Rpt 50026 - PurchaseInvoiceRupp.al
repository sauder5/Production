report 50026 "Purchase Invoice - Rupp"
{
    // //Orig: 10121; modified on 10/28/14
    //   Added PPmt Item No. and PPmt Line Qty.
    // 
    // //RSI-KS 07-23-15
    //   Add Generic description
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/RDLC/PurchaseInvoiceRupp.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Purch. Inv. Line"; "Purch. Inv. Line")
                    {
                        ...
                        column(PPmtItemNo; "Purch. Inv. Line"."Prepmt Item No.")
                        {
                        }
                        column(PPmtLineQty; "Purch. Inv. Line"."Prepmt Line Quantity")
                        {
                        }
                        column(PPmtItemDesc; gsItemDesc)
                        {
                        }
                        column(GenericCode; ItemRec."Generic Name Code")
                        {
                        }
                        ...
                        begin
                            ...
                            //SOC-SC 10-28-14
                            gsItemDesc := '';
                            if "Prepmt Item No." <> '' then begin
                                if recItem.Get("Purch. Inv. Line"."Prepmt Item No.") then begin
    ...
    begin
        PrintCompany := true; //SOC-SC 10-28-14
    end;
