report 50030 "Pick Ticket per Order"
{
    // //Orig: 50018
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/RDLC/PickTicketperOrder.rdlc';
    UsageCategory = ReportsAndAnalysis;

    Caption = 'Pick Ticket Per Order';
        ...
        dataitem("Warehouse Activity Header"; "Warehouse Activity Header")
        {
            ...
            dataitem("Warehouse Activity Line"; "Warehouse Activity Line")
            {
                ...
                dataitem("Sales Header"; "Sales Header")
                {
                    ...
                    column(CreditCardAuth; gsCreditCardAuthNo)
                    {
                    }
                    column(CreditCardAuthCaption; gsCreditCardAuthNoCaption)
                    {
                    }
                    ...
                    dataitem(LocationLoop; "Integer")
                    {
                        ...
                        dataitem(CopyNo; "Integer")
                        {
                            ...
                            dataitem(PageLoop; "Integer")
                            {
                                ...
                                column(CreatedBy; "Sales Header"."Created By")
                                {
                                }
                                column(txtReprint; gsReprint)
                                {
                                }
                                column(CustPriceGroup; "Sales Header"."Customer Price Group")
                                {
                                }
                                column(EmailAddress; gsEmail)
                                {
                                }
                                column(eShipService; "Sales Header"."E-Ship Agent Service")
                                {
                                }
                                dataitem("Sales Line"; "Sales Line")
                                {
                                    ...
                                    dataitem(tmpComments; "Sales Comment Line")
                                    {
                                        DataItemLink = "No." = FIELD("Document No."), "Document Type" = FIELD("Document Type"), "Document Line No." = FIELD("Line No.");
                                        DataItemTableView = SORTING("Document Type", "No.", "Document Line No.", "Line No.") WHERE("Document Type" = CONST(Order), "Print On Pick Ticket" = CONST(true));
                                        UseTemporary = true;
                            ...
                            dataitem("Sales Comment Line"; "Sales Comment Line")
                            {
                                ...
                                DataItemLinkReference = "Sales Header";
                                DataItemTableView = SORTING("Document Type", "No.", "Document Line No.", "Line No.") WHERE("Print On Pick Ticket" = CONST(true), "Document Line No." = FILTER(0));
                                PrintOnlyIfDetail = true;
                    ...
                    begin
                        ...
                        if "Shipping Agent Code" = '' then
                            ...
                            if "Shipping Agent Code" = 'UPS' then
                                ShipmentAgent.Name := "Shipping Agent Code" + '-' + "E-Ship Agent Service"
                            else
                                ShipmentAgent.Get("Shipping Agent Code");
                        ...
                        if not RuppWhseMgt.GetCreditCardAuthNo("Sales Header", gsCreditCardAuthNoCaption, gsCreditCardAuthNo) then begin
                            if not Confirm('Sales Order %1 has not been authorized for Credit Card. Do you want to still want to proceed', false, "No.") then begin
                                CurrReport.Break();
                            end;
                        end;
                        gdPickAmount := GetTotals("Sales Header"."No.");
                        gsEmail := GetEmail("Sales Header");
                    end;
                }
    ...
    begin
        ...
        if recSalesLine.FindSet() then begin
            repeat
                ...
                ShipTotal += PickQty * recSalesLine."Unit Price";
                    ...
                    case Type of
                        ...
                        Type::" ":
                            begin
                                ...
                                tmpComments."Print On Pick Ticket" := true;
                                tmpComments.Insert;
                            end;
                    end;
                until recSalesLine.Next = 0;
    ...
    local procedure GetEmail(recHeader: Record "Sales Header") gsEmail: Text[100]
    var
