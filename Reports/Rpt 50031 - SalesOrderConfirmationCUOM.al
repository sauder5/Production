report 50031 "Sales Order Confirmation-CUOM"
{
    // //SOC-RB
    // //SOC-SC 10-16-14
    // //RSI-KS 07-22-15
    //   Add Payment method
    // 
    // //SOC-SC 09-17-15 Copied from 50015 for Kristen; only for templorary use until 50015 is modified to accommodate Unit Price per CUOM
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/RDLC/SalesOrderConfirmationCUOM.rdlc';
                        ...
                        begin
                            ...
                            with TempSalesLine do begin
                                ...
                                if Quantity = 0 then
                                  ...
                                  //UnitPriceToPrint := ROUND(AmountExclInvDisc / Quantity,0.00001);   //SOC-SC 09-17-15 commenting

                                  //SOC-SC 09-17-15
                                  begin
                                    if gbShowUnitPricePerCUOM then begin
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(gbShowUnitPricePerCUOM; gbShowUnitPricePerCUOM)
                    {
                        Caption = 'Show Unit Price per CUOM';
                    }
                }
            }
        }
    ...
    var
        ...
        gbShowUnitPricePerCUOM: Boolean;
