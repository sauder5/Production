report 50056 "Settlement Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/RDLC/SettlementReport.rdlc';
    ...
    dataset
    {
        dataitem("Settlement-Prepayment Ticket"; "Settlement-Prepayment Ticket")
        {
            ...
            RequestFilterFields = "Settlement No.", "Vendor No.", "Settlement Date", "Generic Name Code";
                ...
                dataitem("Grower Ticket"; "Grower Ticket")
                {
                    ...
                    dataitem("Scale Ticket Header"; "Scale Ticket Header")
                    {
                        ...
                        dataitem("Production Lot"; "Production Lot")
                        {
                            ...
                            begin
                                GrossSettlementAmount := Round((("Settlement-Prepayment Ticket"."Base Settlement Price" +
                                        "Grower Ticket"."Total Premi / Disc per UOM") * "Settlement Applied Amounts"."Quantity Applied"), 0.01, '=');
